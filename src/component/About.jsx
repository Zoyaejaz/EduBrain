        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-0">
              ...
              <div className="text-gray-300 leading-relaxed space-y-8 mt-4">
                <p>
              ...
              <button className="bg-white hover:bg-blue-700 text-[#000000] px-6 py-2 rounded-full font-medium transition-colors duration-300 text-center">
                Explore Courses
              </button>
            </div>
